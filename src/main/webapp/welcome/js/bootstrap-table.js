...
(function ($) {
    ...
    BootstrapTable.prototype.initPagination = function () {
        ...
        if (!this.options.onlyInfoPagination) {
            ...
            html.push('</div>',
                ...
                sprintf('<li class="page-item page-pre"><a class="page-link" href="#"><span class="glyphicon glyphicon-backward" aria-hidden="true"></span></a></li>',
            ...
            html.push(
                sprintf('<li class="page-item page-next"><a class="page-link" href="#"><span class="glyphicon glyphicon-forward" aria-hidden="true"></span></a></li>',
    ...
    BootstrapTable.prototype.onPageNumber = function (event) {
        event.preventDefault();
        if($(event.currentTarget).text()+'' === '...' || 0+(+$(event.currentTarget).text()) === NaN){
            return;
        }
